package com.epam.ynairlineepam.dao.impl.connectionpool;
...
public class ConnectionPool {
    ...
    private static AtomicBoolean flagNeedInit = new AtomicBoolean(true);
        ...
        if(flagNeedInit.get())
        {
            ...
            try {
                if(instance == null)
                {
                    ...
                    flagNeedInit.set(false);
                }
            }catch (ConnectionPoolException e) {
                throw new DAOException(ConnectionPool.class+ " Impossible to get instance "+ e);
    ...
    private void initPoolData() throws ConnectionPoolException {
        try {
            ...
            InputStream in = getClass().getClassLoader().getResourceAsStream("mysql-connection.properties");
            props.load(in);
            ...
            try {
                poolSize = Integer.parseInt(props.getProperty("db.poolsize"));
        ...
        {
            throw new ConnectionPoolException("IOException in ConnectionPool", e);
        }
    }
